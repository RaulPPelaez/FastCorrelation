...
namespace FastCorrelation{
  ...
  template<class real>
  cufftResult_t cufftExecReal2Complex(cufftHandle &plan,
			     cufftReal_t<real>* d_in,
			     cufftComplex_t<real> *d_out);
  template<>
  cufftResult_t cufftExecReal2Complex<float>(cufftHandle &plan,
  ...
  template<>
  cufftResult_t cufftExecReal2Complex<double>(cufftHandle &plan,
  ...
  template<class real>
  cufftResult_t cufftExecComplex2Real(cufftHandle &plan,
			     cufftComplex_t<real>* d_in,
			     cufftReal_t<real> *d_out);
  template<>
  cufftResult_t cufftExecComplex2Real<float>(cufftHandle &plan,
  ...
  template<>
  cufftResult_t cufftExecComplex2Real<double>(cufftHandle &plan,
