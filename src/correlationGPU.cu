/*Raul P. Pelaez 2018. GPU version of fast correlation. Uses cuFFT. The interface is identical to the CPU version.
...
namespace FastCorrelation{
  namespace GPU{
    ...
    template
    void correlationFFT<float>(FILE *in,
			       int numberElements,
			       int nsignals,
			       int windowSize,
			       int maxLag,
    ...
    template
    void correlationFFT<double>(FILE *in,
				int numberElements,
				int nsignals,
				int windowSize,
				int maxLag,
